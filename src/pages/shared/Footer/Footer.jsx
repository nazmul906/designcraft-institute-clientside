        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 lg:w-1/4">
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-[#D9930D] hover:bg-[#95709A] text-white px-4 py-2 rounded-r-lg transition-colors duration-300 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Subscribe
              </button>
            </form>
